...
{
    public class DateTimePickerOFSolution : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.CalendarioDark16px;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.CalendarioDark16px;
                else
                    calendarIcon = Properties.Resources.CalendarioWhite16px;
                this.Invalidate();
            }
        }
        ...
        // Constructor
        public DateTimePickerOFSolution()
        {
        ...
        {
            int txtWidth = TextRenderer.MeasureText(this.Text, this.Font).Width;
            if (txtWidth <= this.Width - (calendarIconWidth + 20))
